#!/bin/bash
# =============================================================================
# Slurm job: O4+O5 optimization bench — Qwen3.5-35B-A3B on B200
# =============================================================================

#SBATCH --job-name=o4o5_bench
#SBATCH --nodes=1
...
RESULTS_DIR="/workspace/results/o4o5_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " O4+O5 Optimization Bench — B200"
...
TIMEOUT=${TIMEOUT:-1800}" \
    bash /workspace/bench_o4o5_inner.sh
