#!/bin/bash
# =============================================================================
# Slurm job: Strategy D deferred draft bench — Qwen3.5-35B-A3B on B200
# =============================================================================

#SBATCH --job-name=deferred_b200
#SBATCH --nodes=1
...
RESULTS_DIR="/workspace/results/deferred_b200_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " Strategy D: Deferred Draft Bench — B200"
