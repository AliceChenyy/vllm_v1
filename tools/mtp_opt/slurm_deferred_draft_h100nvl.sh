#!/bin/bash
# =============================================================================
# Slurm job: Strategy D deferred draft bench — Qwen3.5-35B-A3B on H100-NVL
# TP=2, only 2 GPUs needed
# =============================================================================

#SBATCH --job-name=deferred_h100
#SBATCH --nodes=1
...
#SBATCH --partition=h100-nvl@qs1/genoa2d24g2l/8gpu-256cpu-2304gb
#SBATCH --account=beta-users_h100-nvl
...
RESULTS_DIR="/workspace/results/deferred_h100nvl_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " Strategy D: Deferred Draft Bench — H100-NVL"
