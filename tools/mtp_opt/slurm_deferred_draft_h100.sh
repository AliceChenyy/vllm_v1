#!/bin/bash
# =============================================================================
# Slurm job: Strategy D deferred draft bench — Qwen3.5-35B-A3B on H100
# Quick validation: overlap draft GPU with CPU bookkeeping via separate stream
# =============================================================================
...
RESULTS_DIR="/workspace/results/deferred_h100_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " Strategy D: Deferred Draft Bench — H100"
