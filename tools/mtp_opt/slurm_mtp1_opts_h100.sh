#!/bin/bash
# =============================================================================
# Slurm job: MTP1 optimization benchmark — Qwen3.5-35B-A3B on H100
...
#SBATCH --partition=h100-80gb-hbm3@cr+mp/viking@cr+mp/8gpu-224cpu-2048gb
...
echo "========================================================"
echo " MTP1 Optimization Bench — H100"
