#!/bin/bash
# =============================================================================
# Slurm job: Aggressive greedy rejection bypass bench — Qwen3.5-35B-A3B on B200
# Tests: mtp1_base, mtp1_o4o5, mtp1_aggressive (O4+O6), GSM8K correctness
# =============================================================================

#SBATCH --job-name=aggr_greedy
#SBATCH --nodes=1
...
RESULTS_DIR="/workspace/results/aggressive_greedy_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " Aggressive Greedy Rejection Bypass Bench — B200"
...
TIMEOUT=${TIMEOUT:-1800}" \
    bash /workspace/bench_aggressive_greedy_inner.sh
