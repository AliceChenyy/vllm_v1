#!/bin/bash
# =============================================================================
# Slurm job: MTP1 decode step profiling — Qwen3.5-35B-A3B on B200
# Profiles no_mtp vs mtp1 to identify 2.52ms MTP overhead source
# =============================================================================

#SBATCH --job-name=mtp1_profile
#SBATCH --nodes=1
...
echo "========================================================"
echo " MTP1 Decode Step Profiling — B200"
