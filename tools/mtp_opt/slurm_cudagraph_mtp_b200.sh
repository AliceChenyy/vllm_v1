#!/bin/bash
# =============================================================================
# Slurm job: CUDA graph minimal capture benchmark — Qwen3.5-35B-A3B on B200
# Tests: mtp1_base (default graphs), mtp1_minimal_graph (O6 patch)
# =============================================================================

#SBATCH --job-name=cg_mtp_opt
#SBATCH --nodes=1
...
RESULTS_DIR="/workspace/results/cudagraph_mtp_${SLURM_JOB_ID}_${TIMESTAMP}"

mkdir -p "${WORKSPACE_HOST}/logs" "${WORKSPACE_HOST}/results"

echo "========================================================"
echo " CUDA Graph Minimal Capture Bench — B200"
...
RESULTS_DIR=${RESULTS_DIR}" \
    bash /workspace/bench_cudagraph_mtp_inner.sh
